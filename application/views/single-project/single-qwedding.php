     ...
     <div class="container">
          <div class="row">
               ...
               <div class="col-md-offset-1 col-md-10 col-sm-12">
                    <h1>Qwedding Template</h1>
                    <a href="<?php echo base_url()?>demo/qwedding/"><i class="fa fa-long-arrow-right"></i> Lihat Demo</a>

                    <div class="col-md-12 col-sm-12">
                         <img src="<?php echo base_url()?>assets/Magnet/images/qdwedding1.png" class="img-responsive" alt="Portfolio">
                    </div>

                    <div class="col-md-6 col-sm-6">
                         <img src="<?php echo base_url()?>assets/Magnet/images/qdwedding2.png" class="img-responsive" alt="Portfolio">
                    </div>

                    <div class="col-md-6 col-sm-6">
                         <img src="<?php echo base_url()?>assets/Magnet/images/qdwedding3.png" class="img-responsive" alt="Portfolio">
                    </div>
